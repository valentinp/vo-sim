function [RMS_error] = vo_model_offline(map_dim, map_type, theta, fov, dz, noiseFactor, pathType, inputLandmarks)
%Revised VO model
...
rover_est_pos_error=zeros(no_steps,1);
    ...
    for step=1:no_steps
       ...
       if norm(Global_R'*T) < map_dim 
        ...
        rover_est_pos_error(step) = norm(rover_est_pos - rover_pos(1:3));
    end
